//ABSTRACCION
 ...
 //CLASES Y METODOS ABSTRACTOS
  ...
  //La palabra clave abstract es un modificador sin acceso, utilizado para clases y métodos:
    //Clase abstracta: 
     //es una clase restringida que no se puede utilizar para crear objetos (para acceder a ella se debe heredar de otra clase).
    //Método abstracto: 
     //solo se puede utilizar en una clase abstracta y no tiene cuerpo. El cuerpo lo proporciona la subclase (heredada de).
  ...
  //Una clase abstracta puede tener métodos tanto abstractos como regulares:
   abstract class Animal {      //Clase abstracta
     ...
     public void sleep() {      //Metodo regular
  ...
  // Subclass (inherit from Animal)
   class Pig extends Animal {     //Se hereda de otra clase
