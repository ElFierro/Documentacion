//INTERFAZ
 ...
 //Una interface es completamente una "clase abstracta" que se utiliza para agrupar métodos relacionados con cuerpos vacíos:
 ...
 //ACCEDER
  ...
  // con la palabra clave implements (en lugar de extends)
  ...
  // Pig "implements" the Animal interface
   class Pig implements Animal {   //Implementando una interfaz
  ...
  //¿Por qué y cuándo utilizar interfaces?
   ...
   //2) Java no admite la "herencia múltiple" (una clase sólo puede heredar de una superclase). 
   //Sin embargo, se puede lograr con interfaces, porque la clase puede implementar múltiples interfaces. 
  ...
  //MULTIPLES INTERFACES
   ...
   class DemoClass implements FirstInterface, SecondInterface {  //Implementar interfaz multiples
